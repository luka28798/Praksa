...
namespace TestProject.WebAPI
{
    public class WebApiApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            builder.RegisterType<HumanFilterModel>().As<IHumanFilterModel>();
            builder.RegisterType<HumanSortModel>().As<IHumanSortModel>();
            builder.RegisterType<HumanSortRepository>().As<IHumanSortRepository>();
